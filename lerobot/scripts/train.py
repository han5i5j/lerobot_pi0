...
def make_optimizer_and_scheduler(cfg, policy):
    ...
    elif cfg.policy.name == 'florence_pi0':
        optimizer = torch.optim.AdamW(policy.parameters(), lr=cfg.training.lr_max, weight_decay=cfg.training.weight_decay, fused=True)
        lr_scheduler = get_constant_schedule_with_warmup(optimizer, num_warmup_steps=cfg.training.warmup_steps)
    else:
